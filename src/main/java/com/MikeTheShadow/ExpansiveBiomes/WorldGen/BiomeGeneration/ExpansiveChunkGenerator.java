...
public class ExpansiveChunkGenerator extends NoiseChunkGenerator<OverworldGenSettings>
{
    ...
    public ExpansiveChunkGenerator(IWorld worldIn, BiomeProvider provider, OverworldGenSettings settingsIn) {
