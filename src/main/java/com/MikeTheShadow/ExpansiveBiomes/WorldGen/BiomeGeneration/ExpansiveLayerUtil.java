...
public class ExpansiveLayerUtil
{
    ...
    public static ExpansiveLayer[] buildOverworldProcedure(long seed, WorldType typeIn, OverworldGenSettings settings) {
        int i = 25;
        ...
        ExpansiveLayer layer = new ExpansiveLayer(immutablelist.get(0));
        ExpansiveLayer layer1 = new ExpansiveLayer(immutablelist.get(1));
        ExpansiveLayer layer2 = new ExpansiveLayer(immutablelist.get(2));
        return new ExpansiveLayer[]{layer, layer1, layer2};
    }
