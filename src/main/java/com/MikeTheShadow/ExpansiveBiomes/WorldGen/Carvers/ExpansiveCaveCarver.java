...
public class ExpansiveCaveCarver extends WorldCarver<ProbabilityConfig>
{
    public ExpansiveCaveCarver(Function<Dynamic<?>, ? extends ProbabilityConfig> p_i49929_1_, int p_i49929_2_) {
