...
public class ExpansiveDeepFrozenOceanBiome extends Biome {
    ...
    public ExpansiveDeepFrozenOceanBiome() {
        ...
        ExpansiveBiomeFeatures.addIcebergs(this);
        ExpansiveBiomeFeatures.addMonsterRooms(this);
        ExpansiveBiomeFeatures.addBlueIce(this);
