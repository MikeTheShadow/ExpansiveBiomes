...
public final class ExpansiveDesertHillsBiome extends Biome {
    public ExpansiveDesertHillsBiome() {
        ...
        ExpansiveBiomeFeatures.addDesertLakes(this);
        ...
        ExpansiveBiomeFeatures.addDeadBushes(this);
        ExpansiveBiomeFeatures.addMushrooms(this);
        ExpansiveBiomeFeatures.addExtraReedsPumpkinsCactus(this);
        ExpansiveBiomeFeatures.addSprings(this);
        ExpansiveBiomeFeatures.addDesertFeatures(this);
