...
public final class ExpansiveJungleHillsBiome extends Biome {
    public ExpansiveJungleHillsBiome() {
        ...
        ExpansiveBiomeFeatures.addBamboo(this);
        ExpansiveBiomeFeatures.func_222323_C(this);
