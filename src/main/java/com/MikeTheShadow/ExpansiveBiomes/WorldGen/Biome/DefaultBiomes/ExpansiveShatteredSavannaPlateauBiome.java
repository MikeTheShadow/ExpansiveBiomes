...
public final class ExpansiveShatteredSavannaPlateauBiome extends Biome
{
    public ExpansiveShatteredSavannaPlateauBiome() {
        ...
        ExpansiveBiomeFeatures.addShatteredSavannaTrees(this);
        ExpansiveBiomeFeatures.addDefaultFlowers(this);
        ExpansiveBiomeFeatures.func_222314_K(this);
