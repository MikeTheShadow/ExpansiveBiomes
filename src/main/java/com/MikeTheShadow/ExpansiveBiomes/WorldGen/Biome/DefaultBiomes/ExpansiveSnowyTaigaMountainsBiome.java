...
public final class ExpansiveSnowyTaigaMountainsBiome extends Biome
{
    public ExpansiveSnowyTaigaMountainsBiome() {
        ...
        ExpansiveBiomeFeatures.addSparseBerryBushes(this);
